...
module.exports.get_room_type =  async (req, res) => {
  ...
  console.log("making request to ezee")
    ...
    const response = await axios.post(`https://live.ipms247.com/booking/reservation_api/listing.php?request_type=RoomTypeList&HotelCode=${selectedHotel.hotel_ezee_code}&APIKey=${selectedHotel.hotel_auth_code}&language=en&publishtoweb=1`);
